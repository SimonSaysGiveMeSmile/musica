export const en = {
  ...
  "song.simplify": "Simplify chords",
  "song.simplifyHint": "Fewer chords to follow. Each stretch keeps one chord; the others are folded into it.",
  "song.grid0": "As detected",
  "song.grid2": "Every 2 beats",
  "song.grid4": "Every bar",
  "song.grid6": "Every 6 beats",
  "song.grid8": "Every 2 bars",
  "song.gridline": "One per line",
  "song.gridLineNeedsLyrics": "One per line needs lyrics. Until they are here it is every 2 bars.",
  "song.changes": "{n} chord changes",
  "song.pick": "Which chord stays",
  "song.pickLongest": "Longest",
  "song.pickFirst": "First",
  "song.pickHint": "Longest keeps the chord that sounds most of the stretch. First keeps the one playing when it starts.",
  "song.inKey": "Only chords from the key",
  "song.inKeyHint": "A chord outside {key} is folded into the one before it.",
  "song.audioTranspose": "Transpose the sound too",
  "song.audioTransposeHint": "The recording plays in the transposed key at the same speed. The capo changes only the fingering, never the sound.",
  "song.hideOnScroll": "Hide controls while reading",
  "song.hideOnScrollHint": "Scroll down and the player and buttons slide away. Tap anywhere or scroll up to bring them back.",
} as const;
