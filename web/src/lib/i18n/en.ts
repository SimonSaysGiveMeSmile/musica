export const en = {
  ...
  "tuner.lockedTo": "Locked to {note} · tap the peg again to release", "tuner.farOff": "Hearing {heard}, locked to {target}", "tuner.stringTile": "{note}: play and lock this string", "tuner.playing": "Playing {note}",
